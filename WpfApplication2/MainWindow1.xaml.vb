...
Class MainWindow
    ...
    Private Sub Form_Load()
        ...
        'Dim CurPrgDir As String = Directory.GetCurrentDirectory() 'get current directory of program
        'If My.Settings.DefaultWalletPath IsNot Nothing Then
        'If File.Exists(My.Settings.DefaultWalletPath) Then
        'TextWalletPath.Text = "Default Wallet.Keys File Path:" & vbCrLf & My.Settings.DefaultWalletPath
        'WalletKeysPath = My.Settings.DefaultWalletPath
        'End If
        'End If
    ...
    Private Sub ButtonSetWalletPath_Click(sender As Object, e As RoutedEventArgs) Handles ButtonSetWalletPath.Click
        ...
        If result = True Then
            ...
            My.Settings.DefaultWalletPath = fDialog.FileName
        Else
            WalletKeysPath = ""
            TextWalletPath.Text = "Please Select Wallet File"
                ...
                If Dir(PathSimpleWallet) <> "" Then
                    ...
                    Else
                        ...
                        If IsProcessRunning("simplewallet.exe") Then    'check if simplewallet.exe is running
                            myPassword = ""
                            Me.Hide()
                            Dim WalletGUI As New WpfApplication2.MainWindow
                            WalletGUI.Show()
                            PathSimpleWallet = ""
                            Me.Close()
                        Else
